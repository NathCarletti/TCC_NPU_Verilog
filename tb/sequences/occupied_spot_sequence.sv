`ifndef OCCUPIED_SPOT_SEQUENCE_SV
`define OCCUPIED_SPOT_SEQUENCE_SV


class occupied_spot_sequence extends uvm_sequence#(axi_transaction);

  `uvm_object_utils(occupied_spot_sequence)

  function new(string name = "occupied_spot_sequence");
    super.new(name);
  endfunction
